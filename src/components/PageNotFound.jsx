  ...
  return (
    <div className="w-screen h-screen flex flex-col justify-center items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
        <g id="my-ocean">
          <path id="my-sky" className="st0" d="M0 0h1000v203.1H0z" />
          <linearGradient
            id="my-water_1_"
          ...
          <path id="my-water" fill="url(#water_1_)" d="M0 200.7h1000V354H0z" />
          <path id="my-land" className="st0" d="M0 273.4h1000V354H0z" />
          <g id="my-bumps">
            <path
              className="st0"
        ...
        <g id="my-train">
          <path className="fill-green-300" d="M344.5 248.5h507.2v37.8H344.5z" />
          <g id="my-wheels">
          ...
          <path id="my-bracefront" className="st7" d="M383.2 285.6h88.1" />
          <path id="my-braceback" className="st7" d="M733.2 285.6h88.1" />
          <g id="my-car-layers">
            <path
              id="my-car"
              className="st8"
            ...
            <g id="my-ladders">
              <g id="my-ladder-f">
                ...
                />
                <path id="my-fb-rung" className="st9" d="M433.8 281.1h17.7" />
                <path id="my-ft-rung" className="st9" d="M433.8 268.6h17.7" />
              </g>
              <g id="my-ladder-b">
                <path
                  id="my-ladder-back"
                ...
                />
                <path id="my-bt-rung" className="st9" d="M851.8 268.6h17.7" />
                <path id="my-bb-rung" className="st9" d="M851.8 281.1h17.7" />
              </g>
            </g>
            <path
              id="my-window-front"
      ...
      <div className="container px-3 py-2 flex flex-col items-center gap-5 text-center">
        <h4 className="font-Montserrat text-xl md:text-2xl text-wabmBlue">
          Uh oh! Looks like you're trying to access an invalid page.
        </h4>
        <button className="my-btn-1 text-white font-semibold text-xl">
          <a href={appConfig.website}>Go to WaBM website</a>
        </button>
      </div>
    </div>
  );
